...
def raytrace():
    ...
    chiefs = visisipy.analysis.raytrace(coordinates=coordinates, wavelengths=[input.wavelength()])
    marginals_top = visisipy.analysis.raytrace(coordinates=coordinates, pupil=(0, 1), wavelengths=[input.wavelength()])
    marginals_bottom = visisipy.analysis.raytrace(
        coordinates=coordinates, pupil=(0, -1), wavelengths=[input.wavelength()]
    )

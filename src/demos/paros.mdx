...
The magnification is calculated in units of pixels per millimeter (px/mm). For example, a magnification of 161 px/mm means that 1 mm on the retina corresponds to 161 pixels in the fundus image.
